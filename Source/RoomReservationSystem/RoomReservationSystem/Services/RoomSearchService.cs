...
namespace RoomReservationSystem.Services
{
    public static class RoomSearchService
    {
        public static List<Room> SearchAvailableRooms(DateTime start, DateTime end)
        {
            ...
            {
                new Room { Id = 1, Type = RoomType.Single, Status = 0, PetsAllowed = true },
                new Room { Id = 2, Type = RoomType.Double, Status = 0, PetsAllowed = true },
                new Room { Id = 3, Type = RoomType.Suite, Status = 0, PetsAllowed = false },
            };
